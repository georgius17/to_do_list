...
const storage = (()=>{
    ...
    function populateStorage(projects){
        if (projects.length == 0){
            ...
            let task2 = factories.taskFactory('Clean my table', 'theres a lot of dust','2020-04-11','Normal');
            let task3 = factories.taskFactory('Manage my books', 'from oldest to newest','2020-03-15','High');
